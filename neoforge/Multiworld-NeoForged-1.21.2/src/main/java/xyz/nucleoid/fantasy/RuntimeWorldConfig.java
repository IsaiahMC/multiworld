...
public final class RuntimeWorldConfig {
    ...
    private boolean flat = false; // Multiworld: To Boolean as we lost API on Forge, was TriState.DEFAULT;
    private boolean flat_isSet = false; // Multiworld: Add field
    ...
    */
    ...
    public boolean mw$isFlatValueChanged() {
    	return this.flat_isSet;
    }
